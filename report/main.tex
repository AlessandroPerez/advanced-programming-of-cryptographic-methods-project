...
\definecolor{ghkeyword}{RGB}{0,77,175}       % GitHub light theme keywords (a darker blue)
\definecolor{ghcomment}{RGB}{106,115,125}     % GitHub light theme comments (a muted green-gray)
\definecolor{ghstring}{RGB}{203,36,49}        % GitHub light theme strings (a strong red)
\definecolor{ghtext}{RGB}{36,41,46}           % GitHub light theme general text (dark gray)
